...
<?php $h1 = "Modifier un utilisateur ou administrateur"; ?>
<?php ob_start(); ?>
<div  class="errors">
<?php if (!empty($_POST))
  {
...
<form class="form" id="form" action="" method="POST">
    ...
    <input type="tel" id="tel" class="tel formEntry"  name="tel" maxlength="14" value="0<?=$user->tel;?>"  pattern="^(?:(?:\+|00)33|0)\s*[1-9](?:[\s.-]*\d{2}){4}$" title="01 02 03 04 05 ou 0102030405" required />
