            ...
            <?php if ( $first ) : ?>
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        <h2 class="title-carousel"><?=$photo->description; ?></h2>
...
<div class="horaires">
<div class="horaires-text">Le Quai Antique est ouvert les mardi, mercredi, jeudi, vendredi, samedi et dimanche <br> de 12h à 15h et de de 19h à 22h <br>
Fermé le lundi</div>
</div>
<section class="custom-flex-column">
      <article class="row justify-content-center">
        <div class="col-sm-5 m-1">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Restaurant le Quai Antique à Chambery</h5>
              <p class="card-text">
        ...
        <div class="col-sm-5 m-1">
          <div class="card">
            <div class="card-body">
              <p class="card-text">
                <p>Le chef et son équipe vous proposent une carte en permanente évolution au fil des saisons.
                    N'hésitez pas à consulter régulièrement la carte et les menus.
                </p>
                <a href="menus-carte.php" class="submit">Voir la carte et les menus</a>
                <a href="booking.php" class="submit">Réserver</a>
              </p>
            </div>
          </div>
        </div>
